...
egress ranges used for lateral tenant traffic. The ACL still allows DNS to that
tenant's own bridge gateway, otherwise package installs inside the tenant would
not be able to resolve public mirrors.
